...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // locations
    Route::middleware('permission:' . AdminPermission::ManageLocations->value)->group(function () {
    ...
    // platform users
    Route::middleware('permission:' . AdminPermission::ManageUsers->value)->group(function () {
    ...
    // admins
    Route::middleware('permission:' . AdminPermission::ManageAdmins->value)->group(function () {
    ...
    // brands
    Route::middleware('permission:' . AdminPermission::ManageBrands->value)->group(function () {
    ...
    // discounts
    Route::middleware('permission:' . AdminPermission::ManageDiscounts->value)->group(function () {
